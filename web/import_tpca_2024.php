<?php
/**
 * Import cen z TPCA2024.xls
 * Importuje pouze ceny pro měřidla, která ještě NEMAJÍ ŽÁDNOU CENU v databázi
 * 
 * PŘED SPUŠTĚNÍM: Zkopíruj TPCA2024.xls do složky web/
 * Spuštění: Otevři v prohlížeči: http://server/import_tpca_2024.php
 */
...
<body>
    <div class="import-container">
        <h1>Import cen z TPCA2024.xls</h1>
        ...
        if (!file_exists($xlsFile)) {
            ...
            echo 'Prosím zkopíruj TPCA2024.xls do složky web/';
            echo '</div>';
            exit;
        }
    ...
    for ($row = 2; $row <= $highestRow; $row++) {
        ...
        $stmt->execute([
            ...
            $rok,
            $cena,
            "Importováno z TPCA2024.xls " . date('Y-m-d H:i:s')
        ]);
        $inserted++;
