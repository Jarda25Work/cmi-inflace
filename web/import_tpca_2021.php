...
<body>
    <div class="import-container">
        <h1>Import cen z TPCA2021.xls</h1>
        ...
        if (!file_exists($xlsFile)) {
            ...
            echo 'Prosím zkopíruj TPCA2021.xls do složky web/';
            echo '</div>';
            exit;
        }
    ...
    for ($row = 2; $row <= $highestRow; $row++) {
        ...
        $stmt->execute([
            ...
            $rok,
            $cena,
            "Importováno z TPCA2021.xls " . date('Y-m-d H:i:s')
        ]);
        $inserted++;
